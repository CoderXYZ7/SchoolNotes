...
LOAD DATA
INFILE '%currentPathMySql%/Attori.csv'
INTO TABLE Attori
...
LOAD DATA
INFILE '%currentPathMySql%/Film.csv'
INTO TABLE Film
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS;
...
LOAD DATA
INFILE '%currentPathMySql%/Recita.csv'
INTO TABLE Recita
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS
...
LOAD DATA
INFILE '%currentPathMySql%/Sale.csv'
INTO TABLE Sale
FIELDS TERMINATED BY ','
LINES TERMINATED BY '\r\n'
IGNORE 1 ROWS;
...
LOAD DATA
INFILE '%currentPathMySql%/Proiezioni.csv'
